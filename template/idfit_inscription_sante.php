...
<head>
    ...
    <link rel="stylesheet" href="css/idfit_inscription_sante.css?v=1778498828">
...
<div class="wrap">
  ...
  <div class="card">
    ...
    <form id="health-form" onsubmit="event.preventDefault(); document.querySelector('[data-action=\'registerUser\']').click();">
      <div class="layout">
        <div class="form-col">
          <div class="u-style-33">
            <div class="field u-style-34">
              <label class="flabel" for="taille"><i class="ti ti-ruler-measure"></i> Taille</label>
              <div class="inp-wrap">
                <input class="inp" name="taille" id="taille" type="number" value="175" placeholder="cm" required>
                <span class="unit">cm</span>
              </div>
            </div>
            <div class="field u-style-34">
              <label class="flabel" for="poids"><i class="ti ti-weight"></i> Poids actuel</label>
              <div class="inp-wrap">
                <input class="inp" name="poids" id="poids" type="number" value="88" placeholder="kg" required>
                <span class="unit">kg</span>
              </div>
            </div>
            <div class="field u-style-34">
              <label class="flabel" for="age"><i class="ti ti-cake"></i> Âge</label>
              <div class="inp-wrap">
                <input class="inp" name="age" id="age" type="number" value="22" placeholder="ans" required>
          ...
          <div class="btn-row">
            <button type="button" class="btn-sec" onclick="allerRetour()">← Retour</button>
            <button type="submit" class="btn-main" data-action="registerUser">
